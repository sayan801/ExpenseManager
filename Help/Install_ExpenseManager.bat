...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "ExpenseManager" /productName "ExpenseManager" > NUL
...
COPY /Y "ExpenseManager.msha" HelpContentSetup.msha
